...
export default function RegisterPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[radial-gradient(circle_at_top,rgba(44,76,192,0.22),transparent_38%),linear-gradient(180deg,#050917_0%,#081223_100%)] px-4 py-12 sm:px-6">
      ...
      <section className="relative w-full max-w-[34rem] rounded-[28px] border border-cyan-400/20 bg-[linear-gradient(180deg,rgba(18,26,48,0.96),rgba(11,18,34,0.96))] px-7 py-8 shadow-[0_24px_90px_rgba(4,10,24,0.75)] backdrop-blur md:px-10 md:py-10">
        ...
        <div className="mt-7 text-center">
          <h1 className="text-3xl font-semibold tracking-tight text-white md:text-[2.2rem]">Create your account</h1>
